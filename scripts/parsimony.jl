...
#TO MOVE BACK
#scp allencoleman@adhara.biostat.wisc.edu:/ua/allencoleman/Phylo/scripts/* /Users/cora/git_repos/NetProject/results/
...
df = readdlm("/Users/cora/git_repos/NetProject/data/Cui_etal/alignments_1183genes/full.phy", skipstart=1); #skips first line of file
...
#Run Parsimony
#rooted with the southern swordtails outgroup clade (SS) (from CSL paper)
for i in 1:10
...
#Future ideas: start parsimony from random network
#scp /Users/cora/git_repos/NetProject/randomNetwork.tre allencoleman@adhara.biostat.wisc.edu:/ua/allencoleman/Phylo/data/
